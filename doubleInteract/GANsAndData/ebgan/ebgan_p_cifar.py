...
every_d_loss_path = "ebgan_every_d_loss_p.txt"
every_g_loss_path = "ebgan_every_g_loss_p.txt"
in_d_loss_list = []
in_g_loss_list = []
...
for line in in_d_loss_list:
    ...
    f3.write(line + '\n')
f3.close()
torch.save(discriminator.state_dict(),  'ebgan_netd.pth')
torch.save(generator.state_dict(),  'ebgan_netg.pth')
