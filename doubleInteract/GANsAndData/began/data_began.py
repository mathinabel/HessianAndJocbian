...
result = []
with open('began_every_d_loss.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('began_every_g_loss.txt', 'r') as f:
    for line in f:
...
result_d1= []
with open('began_every_d_loss_o.txt', 'r') as f:
    for line in f:
...
result_g1 = []
with open('began_every_g_loss_o.txt', 'r') as f:
    for line in f:
