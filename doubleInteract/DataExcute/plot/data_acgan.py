...
result = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/acgan with p 3/acgan_every_acc.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/acgan without p/acgan_every_acc.txt', 'r') as f:
    for line in f:
