...
result = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/dcgan with p 30/dcgan_every_d_loss30.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/dcgan with p 30/dcgan_every_g_loss30.txt', 'r') as f:
    for line in f:
...
result_d1= []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/dcgan without p/dcgan_every_d_loss30.txt', 'r') as f:
    for line in f:
...
result_g1 = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/dcgan without p/dcgan_every_g_loss30.txt', 'r') as f:
    for line in f:
...
plt.plot(y1, result2, '-r', ms=15, label='dcgan with d')
plt.plot(y1, result3, '-g', ms=15, label='dcgan with g')
plt.plot(y1, result4, '-b', ms=15, label='dcgan without d')
plt.plot(y1, result5, '-k', ms=15, label='dcgan without g')
