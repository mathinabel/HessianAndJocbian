...
result = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/cgan with p 15/cgan_every_d_loss.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/cgan with p 15/cgan_every_g_loss.txt', 'r') as f:
    for line in f:
...
result_d1= []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/cgan without p/cgan_every_d_loss.txt', 'r') as f:
    for line in f:
...
result_g1 = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/cgan without p/cgan_every_g_loss.txt', 'r') as f:
    for line in f:
...
plt.plot(y1, result2, '-r', ms=15, label='cgan with d')
plt.plot(y1, result3, '-g', ms=15, label='cgan with g')
plt.plot(y1, result4, '-b', ms=15, label='cgan without d')
plt.plot(y1, result5, '-k', ms=15, label='cgan without g')
