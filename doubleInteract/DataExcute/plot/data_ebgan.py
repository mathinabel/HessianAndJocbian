...
result = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/ebgan with p 15/ebgan_every_d_loss.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/ebgan with p 15/ebgan_every_g_loss.txt', 'r') as f:
    for line in f:
...
result_d1= []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/ebgan without p/ebgan_every_d_loss.txt', 'r') as f:
    for line in f:
...
result_g1 = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/ebgan without p/ebgan_every_g_loss.txt', 'r') as f:
    for line in f:
...
plt.plot(y1, result2, '-r', ms=15, label='ebgan with d')
plt.plot(y1, result3, '-g', ms=15, label='ebgan with g')
plt.plot(y1, result4, '-b', ms=15, label='ebgan without d')
plt.plot(y1, result5, '-k', ms=15, label='ebgan without g')
