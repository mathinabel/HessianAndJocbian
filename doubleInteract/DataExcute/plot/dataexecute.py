...
result = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/aae with p 30/aae_every_d_loss_p.txt', 'r') as f:
    for line in f:
...
result_g = []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/aae with p 30/aae_every_g_loss_p.txt', 'r') as f:
    for line in f:
...
result_d1= []
with open('F:/2021spring/1erciyuangan/gan文章/paperdata/aae_without p/aae_every_g_loss.txt', 'r') as f:
    for line in f:
...
plt.plot(y1, result2, '-r', ms=15, label='aae with g')
plt.plot(y1, result3, '-g', ms=15, label='aae with d')
plt.plot(y1, result4, '-b', ms=15, label='aae without d')
plt.plot(y1, result5, '-k', ms=15, label='aae without g')


plt.title(u"各种ResNet下的结果对比")
plt.xlabel(u"Epoch")
plt.ylabel(u"Rate")
