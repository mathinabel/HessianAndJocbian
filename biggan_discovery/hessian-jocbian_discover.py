...
from hessian_jocbi import hessian_jocbi
...
class DataParallelLoss(nn.Module):
    """
    This is simply a wrapper class to compute the hessian_jocbi efficiently over several GPUs
    """
    ...
    def forward(self, z, y, w, Q):
        penalty = hessian_jocbi(self.G, z, c=y, w=w, G_z=None, Q=Q, multiple_layers=False)
...
def run(config):
    ...
    for epoch in range(state_dict['epoch'], config['num_epochs']):
        ...
        for i, _ in enumerate(pbar):
            ...
            # hessian_jocbi taken w.r.t. w_sampled, NOT z:
            ...
            writer.add_scalar(f'Metrics/hessian_jocbi', penalty.item(), cur_training_iter)
